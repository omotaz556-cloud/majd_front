...
export default function CreatePlanModal({ onClose, onCreate, creating }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-900/80 px-4 backdrop-blur-sm">
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-display text-lg font-bold text-bone">خطة معركة جديدة</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            placeholder="مثال: هجوم البوابة الشرقية"
